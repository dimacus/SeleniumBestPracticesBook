...
public class JSONFixtures {
  ...
  private final static String json ="[\n"
                                    ...
                                    + "    \"description\": \"Isnâ€™t it wonderful that you get to know your partner better and better each year? The person you though you first met is not necessarily the one you see today, isnâ€™t that just the best and happiest thing ever?\",\n"
                                    + "    \"rating\": 4.5,\n"
                                    + "    \"price\": 88.79,\n"
                                    ...
                                    + "    \"description\": \"Donâ€™t you just love taking a long drive to see the in-laws; that feeling of spending hours and hours talking about your relationship, your feelings, and rehashing old memories and admitting how dumb you were to make that mistake.\",\n"
                                    + "    \"rating\": 1.0,\n"
                                    + "    \"price\": 19.99,\n"
